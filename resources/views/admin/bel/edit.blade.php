...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Edit Jadwal Bel</h1>
            <p class="text-sm text-gray-600">Perbarui jadwal bel otomatis</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-orange-600 to-orange-700 px-6 py-4 border-b border-orange-800">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-white">Form Edit Jadwal</h2>
                        <p class="text-orange-100 text-sm">Ubah detail jadwal bel</p>
                    </div>
                </div>
                <button onclick="showHelp()" class="text-white hover:text-orange-100 transition-colors duration-200 p-2 hover:bg-white/10 rounded-lg">
        ...
        <!-- Form Body -->
        <form id="editForm" action="{{ route('bel.update', $schedule->id) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="space-y-2">
                    ...
                    <select name="hari" id="hari" required
                            class="block w-full rounded-lg border-2 border-gray-200 shadow-sm focus:border-orange-500 focus:ring focus:ring-orange-200 focus:ring-opacity-50 py-3 px-4 transition duration-200 bg-gray-50 hover:bg-white">
                ...
                <div class="space-y-2">
                    ...
                    <input type="time" name="waktu" id="waktu" required
                           value="{{ old('waktu', Carbon\Carbon::parse($schedule->waktu)->format('H:i')) }}"
                           class="block w-full rounded-lg border-2 border-gray-200 shadow-sm focus:border-orange-500 focus:ring focus:ring-orange-200 focus:ring-opacity-50 py-3 px-4 transition duration-200 bg-gray-50 hover:bg-white">
                    @error('waktu')
                        <p class="mt-1 text-sm text-red-600 flex items-center">
                            <svg class="h-4 w-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="space-y-2 md:col-span-2">
                    ...
                    <div class="relative">
                        <select name="file_number" id="file_number" required
                                class="block w-full rounded-lg border-2 border-gray-200 shadow-sm focus:border-orange-500 focus:ring focus:ring-orange-200 focus:ring-opacity-50 py-3 px-4 pr-10 appearance-none transition duration-200 bg-gray-50 hover:bg-white">
                            @for($i = 1; $i <= 30; $i++)
            ...
            <div class="mb-6 p-4 bg-orange-50 border-l-4 border-orange-500 rounded-r-lg">
                <div class="flex items-start">
                    <svg class="h-5 w-5 text-orange-600 mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
                    </svg>
                    <div class="text-sm text-orange-800">
                        <p class="font-semibold mb-1">Perhatian:</p>
                        <ul class="list-disc list-inside space-y-1 text-orange-700">
                            <li>Perubahan waktu akan langsung mempengaruhi jadwal bel otomatis</li>
                            <li>Pastikan tidak ada konflik dengan jadwal lain pada hari yang sama</li>
                            <li>Jadwal yang diperbarui akan otomatis aktif</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-3 pt-6 border-t border-gray-200">
                ...
                <button type="submit" id="submitBtn"
                        class="w-full sm:w-auto inline-flex justify-center items-center px-6 py-3 bg-gradient-to-r from-orange-600 to-orange-700 border border-transparent rounded-lg font-semibold text-white hover:from-orange-700 hover:to-orange-800 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                    </svg>
                    <span id="submitText">Update Jadwal</span>
                </button>
            </div>
        </form>
    </div>
...
function showHelp() {
    Swal.fire({
        title: '<span class="text-2xl">📝 Panduan Edit Jadwal</span>',
        html: `
            <div class="text-left space-y-3 p-4">
                <div class="flex items-start gap-3 p-3 bg-orange-50 rounded-lg">
                    <svg class="h-6 w-6 text-orange-600 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"/>
                    </svg>
                    <div>
                        <p class="font-semibold text-gray-800">Hari</p>
                        <p class="text-sm text-gray-600">Ubah hari untuk jadwal bel</p>
                    </div>
                </div>
                <div class="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Sesuaikan waktu bel berbunyi</p>
                    </div>
                </div>
                <div class="flex items-start gap-3 p-3 bg-purple-50 rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Ganti file audio yang diputar</p>
                    </div>
                </div>
            </div>
        `,
