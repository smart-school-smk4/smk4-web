<div class="bg-white shadow-md px-6 py-4 flex justify-between items-center border-b-2 border-gray-100">
    ...
    <div class="flex items-center space-x-4">
        <!-- Notification Bell -->
        <button class="relative p-2.5 rounded-xl bg-gray-50 hover:bg-gray-100 transition duration-200">
        ...
        <!-- Profile Dropdown -->
        <div class="relative">
            <div class="flex items-center space-x-3 cursor-pointer bg-gray-50 rounded-xl px-3 py-2 hover:bg-gray-100 transition duration-200" id="profile-btn">
                <div class="text-right">
                    <p class="text-sm font-semibold text-gray-800">Admin</p>
                    <p class="text-xs text-gray-500">Administrator</p>
                </div>
                <div class="relative">
                    <img src="{{ asset('assets/images/profile.svg') }}" class="w-10 h-10 rounded-full object-cover border-2 border-primary-200">
