                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" id="nomer_absen" name="nomer_absen" required min="1" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('nomer_absen', $siswa->nomer_absen) }}" placeholder="Masukkan nomer absen">
